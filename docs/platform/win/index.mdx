...
<p>
  <a
    ...
    href="http://ghproxy.com/https://github.com/koishijs/koishi-desktop/releases/download/v0.8.0/koishi-desktop-win-x64-v0.8.0.msi"
    target="_blank"
...
<p>
  <a
    className="button button--secondary"
    href="http://ghproxy.com/https://github.com/koishijs/koishi-desktop/releases/download/v0.8.0/koishi-desktop-win-x64-v0.8.0.zip"
    target="_blank"
    rel="noopener noreferrer"
  >
    zip 便携包
