...
<p>
  <a
    ...
    href="http://ghproxy.com/https://github.com/koishijs/koishi-desktop/releases/download/v0.8.1/koishi-desktop-win-x64-v0.8.1.msi"
    target="_blank"
...
<p>
  <a
    className="button button--secondary"
    href="http://ghproxy.com/https://github.com/koishijs/koishi-desktop/releases/download/v0.8.1/koishi-desktop-win-x64-v0.8.1.zip"
    target="_blank"
    rel="noopener noreferrer"
  >
    zip 便携包
...
点击 Koishi 图标即可启动。等待几秒钟，Koishi 将启动并弹出控制台窗口，
现在你可以开始使用 Koishi 了。
